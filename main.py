...
def get_stock_stats(stock, pwd):
  ...
  print("\n\nThe average unit price of ", str(stock.upper()) + " within the past 100 days has been: $" + str(average)) 

  variance = np.var(data_set) 
  print("\n\nThe unit price of " + str(stock.upper()) + "has varied by $" + str(variance) + "since then.")
...
if __name__ == "__main__":
  ...
  pwd = input("Enter the password (API Key):")
